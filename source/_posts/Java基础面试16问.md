...
1. <span style="background-color: #ffaaaa">等待可中断</span>，当持有锁的线程长时间不释放锁的时候，等待中的线程可以选择放弃等待，转而处理其他的任务。
...
![640-6.jfif](https://cdn.jsdelivr.net/gh/LVicBlack/IMG/root/640-6.jfif)
